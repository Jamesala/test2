...
<head>
    <meta charset="utf-8"/>
    <title>{{$config->namesite}} - Выиграй топовую игру всего за 50р!</title>
    ...
    <meta property="og:title" content="{{$config->namesite}} - Выиграй топовую игру всего за 50р!"/>
...
<div class="footer full">
    <a href="/">
	<img class="fgelogo" src="/images/logo.png">
	</a>
